<template>
    ...
    <div id="orderConfirm">
        ...
        <nav-bread>
            <span slot="orderConfirm">Order Confirm</span>
        </nav-bread>
        <div>
                            ...
                            <ul class="cart-item-list">
                                <li v-for="item in cartList" v-if="item.checked=='1'">
                                    ...
                                    <div class="cart-tab-2">
                                        <div class="item-price">{{parseFloat(item.salePrice)|currency('$')}}</div>
                                    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            init(){
                this.$axios.get('http://localhost:27017/users/cartList', {
